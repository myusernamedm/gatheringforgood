...
namespace GatheringForGood.Models
{
    public class AboutViewModel
    {
        ...
        public string WhereDoesNameComeFromTitle { get; set; }
        public string WhereDoesNameComeFromPara { get; set; }
        public string OurMissionTitle {get; set; }
        public string MissionImageThumbnailUrl { get; set; }
        public string OurMissionPara { get; set; }
        public string OurVisionTitle { get; set; }
        public string VisionImageThumbnailUrl { get; set; }
        public string OurVisionPara { get; set; }
        public string OurPromiseTitle { get; set; }
        public string PromiseImageThumbnailUrl { get; set; }
        public string OurPromisePara { get; set; }
        public string OurEssenceTitle { get; set; }
        public string EssenceImageThumbnailUrl { get; set; }
        public string OurEssencePara { get; set; }

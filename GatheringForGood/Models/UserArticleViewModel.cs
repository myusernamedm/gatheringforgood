...
namespace GatheringForGood.Models
{
    public class UserArticleViewModel
    {
        ...
        public string UserArticleShare { get; set; }
        public string uniqueArticleReference { get; set; }
        ...
        public FileStreamResult ArticleTitleImageUrl1 { get; set; }
        public string ArticleTitleVideoUrl { get; set; }

...
namespace GatheringForGood.Areas.Identity.Pages.Account
{
    ...
    public class ResetPasswordConfirmationModel : PageModel
    {
        ...
        readonly ConfirmResetPasswordPageLocSourceNames _locSourceConfirmResetPasswordPageNameReferenceLibrary = new ConfirmResetPasswordPageLocSourceNames();
        ...
        public ResetPasswordConfirmationModel(IEmailSender emailSender)
        {
        ...
        public void OnGet()
        {
            PageTabTitle = _locSourceConfirmResetPasswordPageNameReferenceLibrary.GetLocSourcePageTabTitleNameReferenceForConfirmResetPasswordPage();
            Title = _locSourceConfirmResetPasswordPageNameReferenceLibrary.GetLocSourceTitleNameReferenceForConfirmResetPasswordPage();
            SubTitle = _locSourceConfirmResetPasswordPageNameReferenceLibrary.GetLocSourceSubtitleNameReferenceForConfirmResetPasswordPage();
            Heading = _locSourceConfirmResetPasswordPageNameReferenceLibrary.GetLocSourceHeadingNameReferenceForConfirmResetPasswordPage();
        ...
        public async Task<IActionResult> OnPostSaveUserEntryAsync(string newsfeedUserEntry)
        {
            ...
            if (newsfeedUserEntry != null)
            {
                ...
                if (userId != null)
                {
                    ...
                    await SaveUserModalEntry.saveUserEntryAsync(newsfeedUserEntry, userId, "Reset Password Confirmation Page Newsfeed Modal", FeedbackDateTime);
                    await SendEmailModalEntry.sendEmailAsync(_emailSender, newsfeedUserEntry, loggedInUser, "Reset Password Confirmation Page Newsfeed Modal", FeedbackDateTime);
                }
                else
                {
